...
const divs = {
    ...
    "home": {
        "html": "<h1>magarenzo.com</h1><hr><img class='image-left image-mobile' alt='Professional headshot of Michael A. Agarenzo' src='/images/headshot-square.jpg' align='left'><p>Hi &#128075; I'm <strong>Michael</strong>, a <span class='uipath'>Technical Advisor at UiPath</span> with <strong>2.5+ years of experience creating solutions in product engineering</p><p>I develop, support, and consult on enterprise software in NYC</strong> and hold a B.S. in Computer Science from Adelphi University</p><p><em>I'm not looking for new opportunities but my resume is available <a target='_blank' href='mailto:contact@magarenzo.com'>by request <img alt='Email' src='/images/icon-mail-blue.png' width='25' height='25'></a></em></p><p>&copy; 2017 Michael A. Agarenzo.</p>"
    },
    "footer": {
