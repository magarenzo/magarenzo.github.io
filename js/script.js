...
const divs = {
    ...
    "home": {
        "html": "<h1>magarenzo.com</h1><hr><br><img class='image-left image-mobile' alt='Professional headshot of Michael A. Agarenzo' src='/images/headshot-square.jpg' align='left'><p>Hi &#128075; I'm <strong>Michael</strong>, a <span class='uipath'>Technical Advisor at UiPath</span> with <strong>2.5+ years of experience creating solutions in product engineering</strong></p><p><strong>I develop, support, and consult on enterprise software</strong> in NYC, and am a Computer Science graduate of Adelphi University</p><p><em>I'm not currently looking for new opportunities, but my resume is available <a target='_blank' href='mailto:contact@magarenzo.com'>by request <img alt='Email' src='/images/icon-mail-blue.png' width='25' height='25'></a></em></p>"
    },
    "copyright": {
        "html": "<hr><p><em>&copy; 2017-2020 Michael A. Agarenzo.</em></p>"
    },
    "footer": {
...
function error() {
    ...
    $("#error").html("<h1>Error 404 - Page Not Found</h1><hr><br><img class='image-left image-mobile' alt='Professional headshot of Michael A. Agarenzo' src='/images/headshot-square.jpg' align='left'><p>Did you expect something to be here?</p><p>Let me know <a href='mailto:contact@magarenzo.com' target='_blank'>by reaching out <img alt='Email' src='/images/icon-mail-blue.png' width='25' height='25'></a></p>");
